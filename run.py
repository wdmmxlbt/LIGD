...
def run():
    ...
    if args.mode == 'train':
        from methods.ligd.pretrain_manager import PretrainManager
        from methods.ligd.manager import Manager
    ...
    elif args.mode == 'ligd_finetune':
        from methods.ligd.ligd_manager import ALManager
        print('LIGD Fine-tuning Begin...')
